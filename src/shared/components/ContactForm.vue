<template>
  <div class="w-full max-w-lg bg-neutral-900/60 backdrop-blur-md p-8 border-l-4 border-[#00ffff] rounded-none shadow-[0_0_15px_rgba(0,255,255,0.3)] pointer-events-auto">
    ...
    <div class="mt-8 pt-6 border-t border-neutral-800 flex justify-center space-x-6">
      ...
      <a href="https://www.linkedin.com/in/matheusaugustop/" target="_blank" rel="noopener noreferrer" class="text-neutral-500 hover:text-[#00ffff] transition-colors" title="LinkedIn">
        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
      </a>
      <a href="https://www.instagram.com/matheusaugustop" target="_blank" rel="noopener noreferrer" class="text-neutral-500 hover:text-[#ff00ff] transition-colors" title="Instagram">
      ...
      <a href="https://www.facebook.com/matheus.augusto.58726/" target="_blank" rel="noopener noreferrer" class="text-neutral-500 hover:text-[#3b5998] transition-colors" title="Facebook">
